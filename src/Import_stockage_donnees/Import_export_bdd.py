...
class ResultatsEnquete(object):
    ...
    def __init__(self, bdd='ech24'):
        """
        attributs : 
            bdd : string : texte de raccourci de connexion
            dfParticipants : equivalent de la table participants de la bdd
            declarations_ok : equivalent de la table situ_gene de la bdd
            declarations_ko : equivalent de la table situ_gene_ko de la bdd
            dicoCharts : dico comprenant des charts pour les principales info de décla de situ de gene : 
                        'sensibilite', 'gene', 'genre', 'emploi', 'periode_travail', 'bati_type', 'bati_annee', 
                        'exploitable', 'temporalite', 'duree_standardisee', 'note_gene_valeurs', 'source_bruit', 
                        'route_source', 'vehicule_source', 'perturbation', 'note_gene_senibilite', 'localisation_gene', 
                        'perturbation_occurence'
        """
        self.bdd = bdd
